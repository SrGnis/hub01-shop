            ...
            <x-card>
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    >
                        ...
                        <x-slot:subtitle class="pl-2 mt-3">
                            @if ($currentUser)
                                <x-button
                                    link="{{ route('user.profile', $currentUser) }}"
                                    label="View profile"
                ...
                <div class="xl:col-span-9">
                    <x-card class="h-full">
                        <div class="space-y-3">
                            ...
                            <x-button
                                link="{{ route('mockup.section', ['section' => 'notifications']) }}"
                                label="View all"
                                icon-right="lucide-square-arrow-out-up-right"
                                class="btn-ghost btn-sm text-primary"
                            />
                ...
                <div class="xl:col-span-3">
                    <x-card>
                        <div class="space-y-3">
                            ...
                            <x-button
                                link="{{ route('mockup.section', ['section' => 'analytics']) }}"
                                label="View more"
                                icon-right="lucide-square-arrow-out-up-right"
                                class="btn-ghost btn-sm text-primary"
                            />

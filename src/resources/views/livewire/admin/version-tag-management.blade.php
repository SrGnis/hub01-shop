<div>
    ...
    ]" :rows="$mainVersionTags" wire:model="expanded" expandable expandable-condition="has_sub_tags" striped>
        @scope('cell_name', $tag)
                    ...
                    @foreach($tag->children as $subTag)
                        <div class="flex items-center gap-2 bg-base-100 p-2 rounded border border-base-300">
                            ...
                            <div class="ml-auto flex gap-1">
                                <x-button icon="lucide-pencil" wire:click="editVersionTag({{ $subTag->id }})" class="btn-ghost btn-xs" />

...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'blade-icons.sets.default.disk' => 'string',
            'blade-icons.sets.default.prefix' => 'string',
            'blade-icons.sets.default.fallback' => 'string',
            'blade-icons.sets.default.class' => 'string',
            'blade-icons.sets.default.attributes' => 'array',
            ...
            'filesystems.links./var/www/laravel/public/storage' => 'string',
            ...
            'mary.icons.package' => 'string',
            'mary.icons.prefix' => 'string',
            'mary.icons.common.close' => 'string',
            'mary.icons.common.chevron-right' => 'string',
            'mary.icons.common.chevron-down' => 'string',
            'mary.icons.common.chevron-left' => 'string',
            'mary.icons.common.chevron-up' => 'string',
            'mary.icons.common.chevron-up-down' => 'string',
            'mary.icons.common.eye' => 'string',
            'mary.icons.common.eye-slash' => 'string',
            'mary.icons.common.sun' => 'string',
            'mary.icons.common.moon' => 'string',
            'mary.icons.common.x-circle' => 'string',
            'mary.icons.common.scissors' => 'string',
            'mary.icons.common.plus-circle' => 'string',
            'mary.icons.common.backspace' => 'string',
            'mary.icons.common.bars-3-bottom-right' => 'string',
            'mary.icons.common.information-circle' => 'string',
            'mary.icons.common.check-circle' => 'string',
            'mary.icons.common.warning-triangle' => 'string',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','blade-icons.sets.default.path','blade-icons.sets.default.disk',
'blade-icons.sets.default.prefix','blade-icons.sets.default.fallback','blade-icons.sets.default.class','blade-icons.sets.default.attributes','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','blade-lucide-icons.prefix',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/laravel/public/storage',
...
'fortify.features','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'markdown.slug_normalizer.unique','markdown.code_highlighting.enabled','markdown.code_highlighting.theme','markdown.add_anchors_to_headings','markdown.render_anchors_as_links',
'markdown.commonmark_options','markdown.cache_store','markdown.cache_duration','markdown.renderer_class','markdown.block_renderers',
'markdown.inline_renderers','markdown.inline_parsers','mary.prefix','mary.route_prefix','mary.icons.package',
'mary.icons.prefix','mary.icons.common.close','mary.icons.common.chevron-right','mary.icons.common.chevron-down','mary.icons.common.chevron-left',
'mary.icons.common.chevron-up','mary.icons.common.chevron-up-down','mary.icons.common.eye','mary.icons.common.eye-slash','mary.icons.common.sun',
'mary.icons.common.moon','mary.icons.common.x-circle','mary.icons.common.scissors','mary.icons.common.plus-circle','mary.icons.common.backspace',
'mary.icons.common.bars-3-bottom-right','mary.icons.common.information-circle','mary.icons.common.check-circle','mary.icons.common.warning-triangle','mary.components.spotlight.class',
...
'livewire.upload-file','livewire.preview-file','mary.toogle-sidebar','mary.spotlight','mary.upload','admin.dashboard','admin.users','admin.projects','admin.site','user.profile','user.profile.edit','email-change.authorize','email-change.verify',
'password-change.verify','membership.accept','membership.reject','project.create','project-search',
'dummy.project.show','project.show','project.edit','project.version.create','project.version.show',
'project.version.edit','file.download','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.two-factor-challenge','auth.verify-email','components.flash-messages','components.layouts.admin','components.layouts.auth',
'components.layouts.navbar','components.project-card','components.project-creators','components.project-links','components.project-recent-versions',
'components.project-show-changelog','components.project-show-description','components.project-show-versions','components.project-version-dependencies','livewire.admin.dashboard',
'livewire.admin.project-management','livewire.admin.project-type-management','livewire.admin.site-management','livewire.admin.tag-group-management','livewire.admin.tag-management',
'livewire.admin.user-management','livewire.admin.version-tag-group-management','livewire.admin.version-tag-management','livewire.auth.confirm-password','livewire.auth.forgot-password',
'livewire.auth.login','livewire.auth.register','livewire.auth.reset-password','livewire.auth.two-factor-challenge','livewire.auth.verify-email',
'livewire.project-form','livewire.project-search','livewire.project-show','livewire.project-version-form','livewire.project-version-show',
'livewire.user-account-security','livewire.user-profile','livewire.user-profile-edit','livewire::simple-tailwind','livewire::tailwind',
'vendor.livewire.simple-tailwind','vendor.livewire.tailwind','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'livewire::simple-tailwind','livewire::tailwind','markdown::markdown','notifications::email','pagination::bootstrap-4',
...
'APP_PORT','VITE_PORT','APP_IMAGE','APP_NAME','APP_LOGO',
'APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS',
'LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','CACHE_STORE',
'REDIS_CACHE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','VITE_APP_NAME',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','DEBUGBAR_ENABLED',);
